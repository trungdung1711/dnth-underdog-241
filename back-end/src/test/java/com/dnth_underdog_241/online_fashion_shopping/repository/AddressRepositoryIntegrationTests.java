...
public class AddressRepositoryIntegrationTests
{
    ...
    @Test
    public void getWebUser_WithPhoneNumber_ReturnTrueAddress()
    {
        /* For getting the phone number only
         * For comparing the address only */
        ...
        Assertions
                ...
                .isPresent();
        Assertions
                .assertThat(webUserOptional.get().getAddress().getProvince())
                .isEqualTo(addressA.getProvince());
        Assertions
                .assertThat(webUserOptional.get().getAddress().getCity())
                .isEqualTo(addressA.getCity());
        Assertions
                .assertThat(webUserOptional.get().getAddress().getWard())
                .isEqualTo(addressA.getWard());
        Assertions
                .assertThat(webUserOptional.get().getAddress().getStreet())
                .isEqualTo(addressA.getStreet());
    }
}
