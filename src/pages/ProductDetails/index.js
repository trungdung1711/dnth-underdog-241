...
function ProductDetails() {
  ...
  const product = {
    id: "1",
    name: "Classic Zipper Hoodie Boxy 2.0",
    price: 620000,
    image: MImg,
    color: selectedColor,
    size: selectedSize,
    ...
    <div>
      ...
      <div className={cx("content")}>
        ...
        <div className={cx("product-page")}>
          ...
          <div className={cx("product-main-image")}>
            <img src={MImg} alt="Classic Zipper Hoodie Boxy 2.0" />
          </div>

          <div className={cx("product-details")}>
            <h1>Classic Zipper Hoodie Boxy 2.0</h1>
            <div className={cx("rating")}>⭐️⭐️⭐️⭐️☆ (150 Reviews)</div>
            <div className={cx("price")}>{product.price.toLocaleString()} đ</div>

            <div className={cx("color")}>
              <span>Màu sắc:</span>
              <button
                className={cx("color-option", { black: true })}
            ...
            <div className={cx("size")}>
              ...
              {["XS", "S", "M", "L", "XL"].map((size) => (
                <button
                  key={size}
                  className={cx("size-option", { selected: size === selectedSize })}
